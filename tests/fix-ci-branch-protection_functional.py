"""
Functional tests for FIX_CI_BRANCH_PROTECTION feature.
...
class TestFIX_CI_BRANCH_PROTECTIONFunctional:
    """Functional test suite for FIX_CI_BRANCH_PROTECTION feature."""
