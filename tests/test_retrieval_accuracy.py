...
class TestRetrievalAccuracy:
    ...
    @pytest.mark.parametrize("question, expected_phrases, doc_context", [
        ...
        (
            "Who is the mother of John Connor?", 
            ["Sarah Connor"], 
            "terminator.txt"
        ),
        ...
        (
            ...
            ["Usage", "Square Footage", "Storeys", "Construction Type", "Sprinklered"], 
            "bcbc_restored.txt"
        ),
        (
    ...
    async def test_retrieval_accuracy(self, question, expected_phrases, doc_context):
        ...
        async with httpx.AsyncClient(timeout=60.0) as client:
            ...
            try:
                ...
                print(f"🗣️  Answer: {answer[:200]}..." if len(answer) > 200 else f"🗣️  Answer: {answer}")
                ...
                if not found_any:
                    ...
                    pytest.fail(f"Answer did not contain expected key phrases. Answer: {answer}")
                else:
