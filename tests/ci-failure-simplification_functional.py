"""
Functional tests for CI_FAILURE_SIMPLIFICATION feature.
...
class TestCI_FAILURE_SIMPLIFICATIONFunctional:
    """Functional test suite for CI_FAILURE_SIMPLIFICATION feature."""
