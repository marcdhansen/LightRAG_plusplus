...
async def test_beekeeping_hallucination_repair(rag_instance):
    ...
    try:
        ...
        await rag.ainsert("Beekeepers manage honey bee colonies for pollination and honey production.")
        
        await rag.acreate_entity("Beekeeper", {"entity_type": "Person", "description": "A beekeeper."})
        await rag.acreate_entity("Heart Disease", {"entity_type": "Disease", "description": "A medical condition."})
    ...
    exists = await rag.chunk_entity_relation_graph.has_edge("Beekeeper", "Heart Disease")
    ...
    exists_after = await rag.chunk_entity_relation_graph.has_edge("Beekeeper", "Heart Disease")
