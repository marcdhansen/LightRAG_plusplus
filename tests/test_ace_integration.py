...
async def test_ace_live_integration(tmp_path):
    ...
    await rag.ainsert("LightRAG is a Retrieval-Augmented Generation system. It uses knowledge graphs to structure information.")
    ...
    assert len(new_playbook.content.lessons_learned) == len(playbook.content.lessons_learned)
