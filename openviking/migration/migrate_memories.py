    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            for item in data:
                ...
                item_id = item.get("id") or item.get("timestamp") or f"{file_path.stem}_{success_count}"
        ...
        logger.info(f"Successfully migrated {success_count}/{len(data)} items from {file_path.name}")
