...
from lightrag.api.routers.ace_routes import create_ace_routes
from lightrag.api.routers.document_routes import (
    DocumentManager,
    create_document_routes,
)
from lightrag.api.routers.graph_routes import create_graph_routes
from lightrag.api.routers.highlight_routes import create_highlight_routes
...
def create_app(args):
    ...
    if args.rerank_binding != "null":
        from lightrag.rerank import ali_rerank, cohere_rerank, jina_rerank, local_rerank
    ...
    app.include_router(create_ace_routes(rag, api_key))
