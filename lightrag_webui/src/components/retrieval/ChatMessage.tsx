      ...
      className={`${
        message.role === 'user'
          ...
          : message.isError
            ...
            : isACE
              ? 'w-[95%] border-2 border-indigo-200 bg-indigo-50 shadow-lg shadow-indigo-500/10 dark:border-indigo-800 dark:bg-indigo-950/30'
              : 'bg-muted w-[95%] border border-transparent'
      } relative rounded-lg px-4 py-2 transition-all duration-300`}
    >
      {isACE && (
        <div className="absolute -top-2 -right-2 z-10 animate-pulse rounded-full bg-gradient-to-r from-indigo-500 to-purple-600 px-2 py-0.5 text-[10px] font-bold text-white shadow-md">
          ACE MODE
        </div>
      )}
