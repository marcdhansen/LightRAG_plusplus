      ...
      <div className="bg-background flex h-screen w-screen flex-col">
        <div className="flex flex-1 items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-muted-foreground font-mono text-sm">Initializing LightRAG...</p>
          </div>
        </div>
      </div>
    )
        ...
        <CardHeader className="flex items-center justify-center space-y-2 pt-6 pb-8">
          <div className="flex flex-col items-center space-y-4">
            <div className="flex items-center gap-3">
              <img src="logo.svg" alt="LightRAG_gemini Logo" className="h-12 w-12" />
              <ZapIcon className="size-10 text-emerald-400" aria-hidden="true" />
            </div>
            <div className="space-y-2 text-center">
              <h1 className="text-3xl font-bold tracking-tight">LightRAG_gemini</h1>
